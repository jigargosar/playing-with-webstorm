...
import { clampIdx, findIndexById, rejectById } from '../lib/ramda-ext'
import { xGet, xSet, xToggleProp } from './xUtils'
...
export const handleDeleteSelectedTask = () => rejectById(store.id, store.tasks)
